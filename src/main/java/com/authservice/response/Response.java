...
public class Response<T> extends BaseResponse {
    ...
    /**
     * El objeto de datos principal que se devuelve en la respuesta.
    ...
    /**
     * Crea una respuesta de éxito con datos y un mensaje.
     *
     * @param data El objeto de datos a devolver.
     ...
     */
    public static Response<Void> error(int statusCode, String message) {
        return Response.<Void>builder()
                .success(false)
     ...
     */
    public static Response<Void> error(int statusCode, String message, List<String> errors) {
        return Response.<Void>builder()
                .success(false)
                .statusCode(statusCode)
                .message(message)
